...
export type AgendaProps = CalendarListProps & ReservationListProps & {
    ...
    /** calendar Initial Offset when change styles such as height, fontSize, etc */
    calendarInitialOffset?: number;
};
type State = {
...
export default class Agenda extends Component<AgendaProps, State> {
    ...
    static propTypes: {
        ...
        calendarInitialOffset?: React.Validator<number | null | undefined> | undefined;

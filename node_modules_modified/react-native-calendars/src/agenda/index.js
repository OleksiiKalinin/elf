...
export default class Agenda extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (!sameDate(newSelectedDate, prevState.selectedDay)) {
            if (!this.state.calendarScrollable) this.calendar?.current?.scrollToDay(this.state.selectedDay, this.calendarOffset(), true);
    ...
    calendarOffset() {
        return (Number(this.props.calendarInitialOffset) || 96) - this.viewHeight / 2;
    }
    ...
    renderReservations() {
        ...
        return (<ReservationList {...reservationListProps} getRef={this.props.getRef} ref={this.list} selectedDay={this.state.selectedDay} topDay={this.state.topDay} onDayChange={this.onDayChange}/>);
    }
    renderCalendarList() {

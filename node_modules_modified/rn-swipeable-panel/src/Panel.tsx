...
class SwipeablePanel extends Component<SwipeablePanelProps, SwipeablePanelState> {
  ...
  constructor(props: SwipeablePanelProps) {
    ...
    this.state = {
      ...
      panelHeight: !!props.panelHeight ? (props.panelHeight + 25) : PANEL_HEIGHT,
    };
  ...
  _onOrientationChange = () => {
    ...
    this.setState({
      ...
      deviceWidth: FULL_WIDTH,
      deviceHeight: FULL_HEIGHT,
      panelHeight: this.state.panelHeight || PANEL_HEIGHT,
    });
...
const SwipeablePanelStyles = StyleSheet.create({
  background: {
    position: Platform.select({ native: 'absolute', web: 'fixed' }),
    zIndex: 1,
    bottom: 0,
    top: 0,
    left: 0,

...
export default class NotifService {
  ...
  constructor(onNotification?: PushNotificationOptions['onNotification'], onRegister?: PushNotificationOptions['onRegister']) {
    this.lastId = 0;
    this.lastChannelCounter = 0;

    this.createDefaultChannels();

    onRegister && notificationHandler.attachRegister(onRegister);
    onNotification && notificationHandler.attachNotification(onNotification);
  ...
  checkPermission: typeof PushNotification.checkPermissions = (cbk) => {
  ...
  getScheduledLocalNotifications: typeof PushNotification.getScheduledLocalNotifications = (callback) => {
    PushNotification.getScheduledLocalNotifications(callback);
  }

  getDeliveredNotifications: typeof PushNotification.getDeliveredNotifications = (callback) => {

...
import { Dimensions, StyleSheet, TouchableHighlight, TouchableOpacity, View, Image } from 'react-native';
...
const VideoScreen: React.FC = () => {
  ...
  return open && (
    <ScreenHeaderProvider transparent staticContentHeightOnWeb>

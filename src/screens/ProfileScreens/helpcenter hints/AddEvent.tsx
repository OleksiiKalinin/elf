...
type AddEventProps = CompositeScreenProps<
  NativeStackScreenProps<ProfileStackParamList, 'AddEvent'>,
  NativeStackScreenProps<RootStackParamList, 'ProfileStack'>
>;

const AddEvent: React.FC<AddEventProps> = ({ navigation }) => {
  const steps = [
    ...
    <Typography weight="Regular">
      Wybierz <Typography weight="Bold">„Zaplanuj spotkanie”</Typography>.
    </Typography>,
    <Typography weight="Regular">Uzupełnij informacje.</Typography>,
    <Typography weight="Regular">
      ...
      <View style={styles.Wrapper}>
        <ScrollView style={styles.Content}>
          <Typography
            ...
            Jak dodać nowe wydarzenie w kalendarzu?
          </Typography>
          ...
          <View style={{ marginTop: 50 }}>
            ...
            {/* <ButtonArrowSelector
              text={'Jak zaplanować wydarzenie w kalendarzu?'}
            /> */}

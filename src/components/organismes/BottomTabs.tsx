...
const hiddenTabbarScreens: ScreensType = {
    ...
    MessengerStack: [],
    ProfileStack: ['SettingsScreen', 'PackagesScreen', 'NoCompanyScreen', 'CompanyEditorScreen', 'AddPaymentScreen', 'CompanyScreen', 'EditPaymentScreen', 'MethodsScreen', 'NotificationScreen', 'PaymentScreen', 'PointsScreen', 'PrivacyScreen', 'AccountDataScreen', 'ToolsScreen'],
};

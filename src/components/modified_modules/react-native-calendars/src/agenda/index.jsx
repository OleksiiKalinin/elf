...
export default class Agenda extends Component {
    ...
    enableCalendarScrolling(enable = true) {
        ...
        this.calendar?.current?.scrollToDay(this.state.selectedDay, this.calendarOffset() + Number(Platform.OS === 'ios'), true);
    }

...
import { WEEK_HEIGHT } from '../expandableCalendar';
...
const CalendarList = (props, ref) => {
    ...
    const scrollToDay = (date, offset, animated) => {
        ...
        if (scrollAmount !== 0) {
            // @ts-expect-error
            list?.current?.scrollToOffset({ offset: scrollAmount, animated: animated && (Platform.OS !== 'web') });
        }
    };
